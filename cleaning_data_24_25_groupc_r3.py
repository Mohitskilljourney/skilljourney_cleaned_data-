# -*- coding: utf-8 -*-
"""cleaning_data_24-25_groupC-r3.ipynb
...
# -----------------------------
file_path = "/content/2024-2025_SellList+R3-Allied.xlsx"  # ORIGINAL FILE
df = pd.read_excel(file_path)
...
# Step 8: Save summary
# -----------------------------
summary.to_excel("Cleaning_2024-2025_SellList+R3-Allied.xlsx", index=False)
