# -*- coding: utf-8 -*-
"""cleaning_data_25-26_groupA-r1.ipynb
...
# -----------------------------
file_path = "/content/2025-2026-SellList+R1-MBBS-BDS.xlsx"  # ORIGINAL FILE
df = pd.read_excel(file_path)
...
# Step 8: Save summary
# -----------------------------
summary.to_excel("Cleaning2025-2026-SellList+R1-MBBS-BDS.xlsx", index=False)
