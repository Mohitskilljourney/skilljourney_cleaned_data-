# -*- coding: utf-8 -*-
"""cleaning_data_25-26_groupB-r1.ipynb
...
# -----------------------------
file_path = "/content/2025-2026_SellList-R1-AYUSH.xlsx"  # ORIGINAL FILE
df = pd.read_excel(file_path)
...
# Step 8: Save summary
# -----------------------------
summary.to_excel("Cleaning_2025-2026_SellList-R1-AYUSH.xlsx", index=False)
